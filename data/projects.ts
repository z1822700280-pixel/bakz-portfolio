...
export const projects: Project[] = [
  ...
  },
  {
    ...
    externalLinks: [],
    reflection: {
      zh: '这部作品是我大二寒假在老家用一周时间独立完成的，没有团队，全程一个人操作。设备只有一台 Canon 相机，预算几乎为零，但题材本身不需要太多技术包装——普通人的真实讲述就是最大的力量。\n\n受访的四位对象年龄跨度很大，从二十出头到年过半百。每个人对同样问题的回答截然不同，这种横向对比本身就很有力量。后期剪辑时我尽量保持克制的处理方式，让受访者的话语本身成为影片的核心。',
